...
export default function SmartHelpSlider() {
  ...
  return (
    <div className="flex justify-between sm:mt-[60px] lg:mt-[100px] max-xl:flex-col max-xl:items-center">
      <div className="max-md:flex max-md:flex-col max-md:gap-[10px] max-sm:gap-[8px]">
        ...
        <p className="max-w-[900px] w-full text-(--blue)/60 text-[16px] sm:text-[20px] lg:text-[24px] xl:text-[32px] leading-[120%] max-lg:mt-[10px]">
