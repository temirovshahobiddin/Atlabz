...
const RegSelect = () => {
  ...
  return (
    <div className="flex flex-col justify-center max-w-[892px] mx-auto">
      <h1 className="text-(--blue) max-w-[820px] mx-auto title-1 font-bold text-center  mt-[110px] uppercase">
        Зарегистрируйся
      </h1>
      ...
      <div className="mt-5 mx-auto w-full">
        <Link href="/login">
          <Button rounded="10">Авторизоваться</Button>
        </Link>
      </div>
      ...
      <img
        src={person.src}
        alt=""
        className="max-w-[331px] h-[263px] sm:max-w-[606px] sm:h-[340px]  lg:max-w-[731px] w-full lg:h-[581px] m-auto"
      />
    </div>
  );
};
