    ...
    <div>
      ...
      <div className="mt-[60px] lg:mt-[165px]">
        ...
        <div className="mt-[60px] lg:mt-[150px]">
          ...
          <p className="text-[#3831BF]/60 font-medium text-[16px] sm:text-[20px] lg:text-[24px] xl:text-[32px] leading-[120%]">
          ...
          <div className="w-full flex items-center mt-[30px] lg:mt-0 justify-center">
            <img src={aLTg.src} className="w-[200px] sm:w-[600px] lg:w-[800px] xl:w-[1000px]" alt="" />
          </div>
